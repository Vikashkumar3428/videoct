...
class Premium extends Component {
  ...
  // componentDidMount() {
  //   fetch("https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&q=Trending&key=AIzaSyDEngdaKZQGP__ZfcOWwLgiKUXbO4GMwVU")
  //   .then(res => res.json())
  ...
  //   })
        ...
        return(
                <div className="main">
                <h1 className="text-light {response_series} text-center display-1">Premium</h1>
                   
                   <div className="flex-container container col-md-11 pl-xs-1 pl-md-5">
                   {Premiums.map((bolly, index) => {
